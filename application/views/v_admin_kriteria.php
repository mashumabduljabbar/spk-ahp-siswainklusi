				  ...
				  <table class="table table-bordered table-striped">
					...
					<tr>
						...
						<?php for($akhir = $minimal_kriteria; $akhir <=$maksimal_kriteria; $akhir++){?>
							...
							$nilai_perbandingan_kriteria[$awal][$akhir] = round($nilai_awal_kriteria[$akhir]/$nilai_awal_kriteria[$awal],2);
				...
				<h5><strong>Matriks Bobot Prioritas Nilai Kriteria</strong></h5>
				  <table class="table table-bordered table-striped">
					...
					<tr>
						...
						<?php for($akhir = $minimal_kriteria; $akhir <=$maksimal_kriteria; $akhir++){?>
							<td style="text-align:center;"><?php 
							$nilai_prioritas_kriteria[$awal][$akhir] = round($nilai_awal_kriteria[$akhir]/$nilai_awal_kriteria[$awal]/$jumlah_nilai_perbandingan_kriteria[$akhir],2);
						...
						?></th>
						<th style="text-align:center;"><?php $bobot_prioritas_kriteria[$awal] = round($jumlah_nilai_prioritas_kriteria[$awal]/$count_kriteria,2);
				...
				<h5><strong>Nilai Eigen Kriteria</strong></h5>
				  <table class="table table-bordered table-striped">
					...
					<tr>
						...
						<th style="text-align:center;">
						<?php 
						$lambda_max_kriteria = round($jumlah_eigen_prioritas_kriteria/$count_kriteria,2);
					...
					<tr>
						...
						<th style="text-align:center;">
						<?php 
						$consistency_index_kriteria = round(($lambda_max_kriteria-$count_kriteria)/($count_kriteria-1),2);
					...
					<tr>
						...
						<th style="text-align:center;">
						<?php 
						$consistency_ratio_kriteria = round($consistency_index_kriteria/$ketetapan_nilai,2);

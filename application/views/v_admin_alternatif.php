  <div class="content-wrapper ">
	...
	for($kriteria_id=$minimal_kriteria; $kriteria_id<=$maksimal_kriteria; $kriteria_id++){
						...
						for($x = $minimal_alternatif; $x<=$maksimal_alternatif; $x++){
							$query = $this->db->query("select * from tbl_alternatif, tbl_siswa where tbl_alternatif.siswa_id=tbl_siswa.siswa_id and alternatif_id = '$x' and kriteria_id='$kriteria_id'");
							foreach ($query->result_array() as $row){
								$nilai_awal_alternatif[$x] = $row['alternatif_nilai'];
								$nama_awal_alternatif[$x] = $row['siswa_nama'];
							}
						}
	?>
	...
	<section class="content" >
      <div class="row">
			<div class="col-xs-12">
				  ...
				  <table class="table table-bordered table-striped">
					...
					<tr>
					  ...
					  <?php 
						for($w = $minimal_alternatif; $w<=$maksimal_alternatif; $w++){
							$query = $this->db->query("select * from tbl_alternatif, tbl_siswa where tbl_alternatif.siswa_id=tbl_siswa.siswa_id and alternatif_id = '$w' and kriteria_id='$kriteria_id'");
							foreach ($query->result_array() as $row){
								echo "<th style=\"text-align:center;\">".$row['siswa_nama']."</th>";
							}
						}
					  ?>
					  </th>
					...
					<tr>
						...
						<?php for($akhir = $minimal_alternatif; $akhir <=$maksimal_alternatif; $akhir++){?>
							...
							$nilai_perbandingan_alternatif[$awal][$akhir][$kriteria_id] = round($nilai_awal_alternatif[$akhir]/$nilai_awal_alternatif[$awal],2);
					...
					<?php 
						...
						echo $jumlah_nilai_perbandingan_alternatif[$awal][$kriteria_id];
					?>
					</th>
					<?php } ?>
				...
				<h5><strong>Matriks Bobot Prioritas Nilai Alternatif <?php echo $nama_awal_kriteria[$kriteria_id];?></strong></h5>
				  <table class="table table-bordered table-striped">
					...
					<tr>
						...
						<?php for($akhir = $minimal_alternatif; $akhir <=$maksimal_alternatif; $akhir++){?>
							<td style="text-align:center;"><?php 
							$nilai_prioritas_alternatif[$awal][$akhir][$kriteria_id] = round($nilai_awal_alternatif[$akhir]/$nilai_awal_alternatif[$awal]/$jumlah_nilai_perbandingan_alternatif[$akhir][$kriteria_id],2);
						...
						?></th>
						<th style="text-align:center;"><?php $bobot_prioritas_alternatif[$awal][$kriteria_id] = round($jumlah_nilai_prioritas_alternatif[$awal][$kriteria_id]/$count_alternatif,2);
				...
				<!-- /.box-header -->
				<div class="box-body">
				<h5><strong>Nilai Eigen Alternatif <?php echo $nama_awal_kriteria[$kriteria_id];?></strong></h5>
				  <table class="table table-bordered table-striped">
					<thead>
					<tr>
					  <th style="text-align:center;">Jumlah</th>
					...
					?>
					<tr>
						<th style="text-align:center;"><?php echo $jumlah_nilai_prioritas_alternatif[$awal][$kriteria_id]; ?></th>
						<th style="text-align:center;"><?php echo $bobot_prioritas_alternatif[$awal][$kriteria_id]; ?></th>
						<th style="text-align:center;"><?php echo $hasil_eigen_prioritas_alternatif[$awal][$kriteria_id]; ?></th>
					</tr>
					<?php } ?>
					<tr>
						...
						echo $jumlah_eigen_prioritas_alternatif[$kriteria_id];
						?>
						</th>
					</tr>
					<tr>
						...
						<th style="text-align:center;">
						<?php 
						$lambda_max_alternatif[$kriteria_id] = round($jumlah_eigen_prioritas_alternatif[$kriteria_id]/$count_alternatif,2);
						echo $lambda_max_alternatif[$kriteria_id];
						?>
						</th>
					</tr>
					<tr>
						...
						<th style="text-align:center;">
						<?php 
						$consistency_index_alternatif[$kriteria_id] = round(($lambda_max_alternatif[$kriteria_id]-$count_alternatif)/($count_alternatif-1),2);
						echo $consistency_index_alternatif[$kriteria_id];
						?>
						</th>
					</tr>
					<tr>
						...
						<th style="text-align:center;">
						<?php 
						$consistency_ratio_alternatif[$kriteria_id] = round($consistency_index_alternatif[$kriteria_id]/$ketetapan_nilai,2);
						echo $consistency_ratio_alternatif[$kriteria_id];
						?>
						</th>
					</tr>
					<tr>
						<th colspan="3" style="text-align:left;">
						<?php if($consistency_ratio_alternatif[$kriteria_id]<0.1){
							$tanda_konsistensi_alternatif[$kriteria_id] = "<";
							$hasil_konsistensi_alternatif[$kriteria_id] = "baik atau diterima.";
						}else{
							$tanda_konsistensi_alternatif[$kriteria_id] = ">";
							$hasil_konsistensi_alternatif[$kriteria_id] = "kurang baik atau tidak dapat diterima.";
						}
						?>
						Consistency Ratio matriks alternatif <?php echo $nama_awal_kriteria[$kriteria_id];?> bernilai <?php echo $consistency_ratio_alternatif[$kriteria_id]." ".$tanda_konsistensi_alternatif[$kriteria_id];?>  0.1 yang menunjukkan konsistensi <?php echo $hasil_konsistensi_alternatif[$kriteria_id];?>
						</th>
					</tr>
					</thead>
					<tbody>

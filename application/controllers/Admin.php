...
class Admin extends CI_Controller {
	public function __construct(){
		...
		$this->load->model('m_admin_siswa'); // Load M_admin_siswa ke controller ini
	...
	//START INI ADALAH FUNGSI FUNGSI UNTUK HALAMAN SISWA
	public function siswa()
    {
		$data['tbl_siswa'] = $this->m_admin_siswa->view();
        $this->load->view("v_admin_header");
    ...
    {
		$this->load->view("v_admin_header_form");
        $this->load->view("v_admin_siswa_add");
		$this->load->view("v_admin_footer_form");
    }
	public function siswa_ubah($siswa_id)
	{
		$data['tbl_siswa'] = $this->m_admin_siswa->view_by($siswa_id);
		$this->load->view("v_admin_header_form");
    ...
    {
        if($this->input->post('submit')){
			$this->m_admin_siswa->add(); // Panggil fungsi add() yang ada di m_admin_siswa.php
    ...
    {
        if($this->input->post('submit')){
			$this->m_admin_siswa->edit($siswa_id); // Panggil fungsi edit() yang ada di m_admin_siswa.php
			redirect('admin/siswa');
		}    
    }
	public function siswa_aksi_hapus($siswa_id){
			$this->m_admin_siswa->hapus($siswa_id); // Panggil fungsi hapus() yang ada di m_admin_siswa.php
			redirect('admin/siswa');
	}
	//END INI ADALAH FUNGSI FUNGSI UNTUK HALAMAN SISWA
